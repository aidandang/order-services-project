...
export default function ForgotPasswordForm({ formData, formSubmit, errors, onInputChange, buttonDisabled }) {
  return <>
        ...
        <div className="col-xl-4 col-lg-5 col-md-6 col-sm-7">
          ...
          <div className="card mt-3">
            <div className="card-header bg-card-cs">
              <div className="row">
                <div className="col text-uppercase font-weight-bold">Forgot Password</div>
              </div>
            </div>

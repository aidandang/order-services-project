...
import ShippingInfo from './tabs/ShippingInfo';
...
const CustomerSettings = ({
  ...
  useEffect(() => {
    showHeaderWithTabs(PageWrapperList.customerSettings);
    ...
    {  
      ...
      && <>
        ...
        <Tabbar 
          ...
          message={message}
        />
        {tabbar.active.tab === 'GENERAL_SETTINGS' && <GeneralSettings />}
        {tabbar.active.tab === 'SHIPPING_INFO' && <ShippingInfo />}
      </>
    }
  </>
}

export default connect(mapStateToProps, { showHeaderWithTabs, tabActive, componentCleanup })(CustomerSettings);
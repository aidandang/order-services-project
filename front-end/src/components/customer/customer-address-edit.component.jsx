...
const CustomerAddressEdit = ({
  ...
  const obj = byId.shippingInfo.find(item => item._id === id)
  ...
  const [
    ...
    buttonDisabled,
    setValues
  ] = useForm(obj ? obj : formState, formState, formSchema);
  ...
  const formSubmit = () => {
    ...
    patchReq('/customers/' + byId._id, fetchSuccess, customerTemp, setSuccess, 'customer-address-edit');
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(CustomerAddressEdit);
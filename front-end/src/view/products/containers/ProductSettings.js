...
import ColorInfo from './tabs/ColorInfo';
...
const ProductSettings = ({
  ...
  useEffect(() => {
    showHeaderWithTabs(PageWrapperList.productSettings);
  ...
  return <>
    {  
      ...
      && <>
        ...
        {tabbar.active.tab === 'COLOR_INFO' && <ColorInfo />}
      </>
    }
  </>
}

export default connect(mapStateToProps, { showHeaderWithTabs, tabActive, componentCleanup })(ProductSettings);